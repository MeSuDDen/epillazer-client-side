...
export default function PrivacyPolicy() {
	return (
		<div className={style.main}>
			...
			<p>
				Пользователь, оставляя заявку на данном интернет-сайте, принимает
				...
				свою дееспособность, Пользователь дает свое согласие на обработку своих
			...
			<p>
				...
				номера контактных телефонов; адреса электронной почты; место работы и
				занимаемая должность; пользовательские данные (сведения о
			...
			<p>
				...
				физического лица на веб-сайте и функционирования веб-сайта; проведение
			...
			<p>
				...
				персональных данных»; Устав организации; настоящее согласие на обработку
				персональных данных
			</p>
			...
			<p>
				...
				представителем путем направления письменного заявления руководителю
				организации или его представителю по адресу, указанному в разделе
				"Контакты".
			</p>

			<p>
				9. В случае отзыва субъектом персональных данных или его представителем
				согласия на обработку персональных данных вправе продолжить обработку
